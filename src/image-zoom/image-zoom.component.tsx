...
import {
  Animated, LayoutChangeEvent, PanResponder, StyleSheet, View,
} from 'react-native';
...
export default class ImageViewer extends React.Component<ImageZoomProps, ImageZoomState> {
  ...
  private singleClickTimeout: number | any;

  private longPressTimeout: number | any;
  ...
  private imagePanResponder = PanResponder.create({
    ...
    onMoveShouldSetPanResponderCapture: this.props.onMoveShouldSetPanResponder,
